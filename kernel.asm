...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 a2 56 10 80 	movl   $0x801056a2,0x14(%eax)
  p->context = (struct context*)sp;
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037e7:	e8 e4 0a 00 00       	call   801042d0 <pushcli>
  c = mycpu();
801037ec:	e8 4f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037f7:	e8 14 0b 00 00       	call   80104310 <popcli>
}
...
80103856:	e8 55 0c 00 00       	call   801044b0 <memset>
...
801038b5:	e8 d6 0d 00 00       	call   80104690 <safestrcpy>
  p->cwd = namei("/");
...
80103905:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103908:	e8 c3 09 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010390d:	e8 2e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103912:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103918:	e8 f3 09 00 00       	call   80104310 <popcli>
  if(n > 0){
...
80103986:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103989:	e8 42 09 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010398e:	e8 ad fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103993:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103999:	e8 72 09 00 00       	call   80104310 <popcli>
  if((np = allocproc()) == 0){
...
80103ace:	e8 cd 08 00 00       	call   801043a0 <acquire>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 e4 0b 00 00       	call   801046eb <swtch>
      switchkvm();
...
80103b2c:	e8 2f 09 00 00       	call   80104460 <release>
    sti();
...
80103b44:	53                   	push   %ebx
  pushcli();
80103b45:	e8 86 07 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103b4a:	e8 f1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b55:	e8 b6 07 00 00       	call   80104310 <popcli>
  if(!holding(&ptable.lock))
80103b5a:	83 ec 0c             	sub    $0xc,%esp
80103b5d:	68 20 2d 11 80       	push   $0x80112d20
80103b62:	e8 09 08 00 00       	call   80104370 <holding>
...
80103ba3:	e8 43 0b 00 00       	call   801046eb <swtch>
  mycpu()->intena = intena;
...
80103c06:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c09:	e8 c2 06 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103c0e:	e8 2d fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103c13:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c19:	e8 f2 06 00 00       	call   80104310 <popcli>
  if(curproc == initproc)
...
80103c72:	e8 29 07 00 00       	call   801043a0 <acquire>
...
80103d3c:	e8 5f 06 00 00       	call   801043a0 <acquire>
  pushcli();
80103d41:	e8 8a 05 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103d46:	e8 f5 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d51:	e8 ba 05 00 00       	call   80104310 <popcli>
...
80103d69:	e8 f2 06 00 00       	call   80104460 <release>
}
...
80103d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d8f:	e8 3c 05 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103d94:	e8 a7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d9f:	e8 6c 05 00 00       	call   80104310 <popcli>
  if(p == 0)
...
80103dc0:	e8 db 05 00 00       	call   801043a0 <acquire>
    release(lk);
80103dc5:	89 34 24             	mov    %esi,(%esp)
80103dc8:	e8 93 06 00 00       	call   80104460 <release>
  p->chan = chan;
...
80103dea:	e8 71 06 00 00       	call   80104460 <release>
    acquire(lk);
...
80103dfb:	5d                   	pop    %ebp
    acquire(lk);
80103dfc:	e9 9f 05 00 00       	jmp    801043a0 <acquire>
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 56 05 00 00       	call   80104460 <release>
        return pid;
...
80103f23:	e8 38 05 00 00       	call   80104460 <release>
      return -1;
...
80103f3f:	e8 5c 04 00 00       	call   801043a0 <acquire>
...
80103fac:	eb 0c                	jmp    80103fba <wakeupTicketLock+0x2a>
80103fae:	66 90                	xchg   %ax,%ax
80103fb0:	83 c0 7c             	add    $0x7c,%eax
80103fb3:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
80103fb8:	73 1c                	jae    80103fd6 <wakeupTicketLock+0x46>
        if(p->state == SLEEPING && p->pid == pid)
80103fba:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103fbe:	75 f0                	jne    80103fb0 <wakeupTicketLock+0x20>
80103fc0:	3b 58 10             	cmp    0x10(%eax),%ebx
80103fc3:	75 eb                	jne    80103fb0 <wakeupTicketLock+0x20>
            p->state = RUNNABLE;
80103fc5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fcc:	83 c0 7c             	add    $0x7c,%eax
80103fcf:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
80103fd4:	72 e4                	jb     80103fba <wakeupTicketLock+0x2a>
    wakeup1TicketLock(pid);
    release(&ptable.lock);
80103fd6:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
801040ae:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040b1:	ba 20 75 10 80       	mov    $0x80107520,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040b6:	77 11                	ja     801040c9 <procdump+0x59>
801040b8:	8b 14 85 80 75 10 80 	mov    -0x7fef8a80(,%eax,4),%edx
      state = "???";
801040bf:	b8 20 75 10 80       	mov    $0x80107520,%eax
...
801040d1:	68 24 75 10 80       	push   $0x80107524
...
8010410d:	68 61 6f 10 80       	push   $0x80106f61
...
80104195:	e8 e6 fb ff ff       	call   80103d80 <sleep>
  while (lk->locked) {
...
801041a3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041a9:	e8 32 f6 ff ff       	call   801037e0 <myproc>
...
801041f4:	e8 37 fd ff ff       	call   80103f30 <wakeup>
  release(&lk->lk);
...
80104233:	e8 a8 f5 ff ff       	call   801037e0 <myproc>
...
801047b5:	e8 26 f0 ff ff       	call   801037e0 <myproc>
...
801047c3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801047c6:	e8 15 f0 ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104808:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010480b:	e8 d0 ef ff ff       	call   801037e0 <myproc>
...
801054e3:	5d                   	pop    %ebp
  return fork();
801054e4:	e9 97 e4 ff ff       	jmp    80103980 <fork>
...
801054f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054f6:	e8 05 e7 ff ff       	call   80103c00 <exit>
...
80105503:	5d                   	pop    %ebp
  return wait();
80105504:	e9 37 e9 ff ff       	jmp    80103e40 <wait>
...
80105553:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105556:	e8 85 e2 ff ff       	call   801037e0 <myproc>
...
80105577:	78 27                	js     801055a0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105579:	e8 62 e2 ff ff       	call   801037e0 <myproc>
  if(growproc(n) < 0)
...
80105586:	e8 75 e3 ff ff       	call   80103900 <growproc>
...
801055dd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055e0:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
801055f8:	68 a0 54 11 80       	push   $0x801154a0
801055fd:	e8 7e e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105602:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
80105664:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105667:	68 60 4c 11 80       	push   $0x80114c60
8010566c:	e8 2f ed ff ff       	call   801043a0 <acquire>
  xticks = ticks;
80105671:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
80105677:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
